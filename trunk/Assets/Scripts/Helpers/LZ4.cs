...
namespace LZ4Sharp
{
    ...
    {
		public static void Compress(string filePath ,byte[] source) {
			System.IO.File.WriteAllBytes(filePath, Compress(source));
		}
		...
		public static byte[] Decompress(string filePath) {
			return Decompress(System.IO.File.ReadAllBytes(filePath));
		}
